...
public class RadarSysSprint2aControllerOnPcMain implements IApplication {
	...
	protected void configure() {		
 	    sonar      = new SonarProxyAsClient("sonarPxy",RadarSystemConfig.hostAddr, ""+RadarSystemConfig.serverPort, ProtocolType.tcp );
 	    led        = new LedProxyAsClient("sonarPxy",RadarSystemConfig.hostAddr, ""+RadarSystemConfig.serverPort, ProtocolType.tcp );
